...
- **Categorías excluidas** (`categorias.excluir_presupuesto`) no entran en sumas de presupuesto ni en el reporte de gasto por categoría; hay un toggle "Incluir ocultas".
